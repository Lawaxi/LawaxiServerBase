                ...
                .then(CommandManager.argument(messages.get(24, "null"), EntityArgumentType.player())
                        ...
                        .executes(ctx -> {
                            ...
                            if (!TpaRequest.hasrequest(me)) {
                                if (to.equals(me)) {
                                    to.sendMessage(Text.literal(messages.get(33, to.getGameProfile().getName())), false);
                                } else {
                                    ...
                                    if (List.tparequests.add(newrequest)) {
                                        ...
                                        to.sendMessage(Text.literal(messages.get(34, to.getGameProfile().getName()).replace("%from%", me.getEntityName())), false);
